...
<html>
  ...
  color: #333333;">
    ...
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
      ...
      margin: 0 0 20px;
      text-align: center;">Confirm Email</h1>
      <p style=" margin: 0 0 20px;">Dear {{ $data['username'] }},</p>
      <p style=" margin: 0 0 20px;">We received a request to confirm email. If you did not make this request, please ignore this email.</p>
